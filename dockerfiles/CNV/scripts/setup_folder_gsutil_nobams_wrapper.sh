...
~/scripts/CNV_scripts/scripts/setup_folder_gsutil_nobams.sh $workingfolder $gsutil_path $speciescalls_folder $study_id > $logfolder/setup_folder_gsutil.log 2>&1 & 
